            ...
            <div class="flex-1 min-h-0 overflow-hidden">
                <div class="h-full">
                    ...
                    <div
                        ...
                        :key="route.params.id"
                        class="bg-gray-50 rounded-xl shadow-sm p-3 grid grid-cols-1 lg:grid-cols-3 gap-1 h-full">
                        <!-- LEFT SIDE — Application Info (scrollable) -->
                        <div
                            ref="leftColumnRef"
                            class="lg:col-span-2 space-y-4 min-h-0 overflow-y-auto pr-2 pl-2"
                                ...
                                <div class="px-4 py-4">
                                    ...
                                    <div
                                        ...
                                        <div
                                            ...
                                            <!-- Label -->
                                            <span
                                                class="text-[10px] font-semibold text-green-600 uppercase tracking-wider mb-1">
                                                {{ field.label }}
                                            </span>
                                            ...
                                            <div
                                                class="w-full bg-white rounded-md px-3 py-2.5 border border-gray-200 shadow-sm hover:shadow transition-all duration-150">
                                                <span
                                                    class="text-sm text-gray-900 font-medium break-words">
                                                    {{ field.value }}
                                                </span>
                                            </div>
                                        </div>
                                    ...
                                    <div
                                        ...
                                        <div
                                            class="h-14 w-14 rounded-full bg-gray-200 flex items-center justify-center shadow-inner">
                                            <DocumentIcon
                                        ...
                                        <p
                                            class="text-xs text-gray-500 text-center max-w-xs mt-1">
                                            No fields were found for this
                                            application. Once details are added,
                                            they will appear here in a clean,
                            ...
                            <div
                                ...
                                <!-- Header -->
                                <div
                                    class="px-5 py-3 border-b border-gray-300 flex items-center gap-2">
                                    <DocumentIcon
                                        class="w-4 h-4 text-green-600" />
                                    <h3
                                        class="text-[11px] font-bold text-gray-700 uppercase tracking-wider">
                                        Application Type
                                    </h3>
                                </div>
                                ...
                                <div class="px-5 py-4">
                                    <div
                                        class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-2 gap-x-6 gap-y-4">
                                        <!-- Name -->
                                        <div class="flex flex-col">
                                            <span
                                                class="text-[10px] font-semibold text-green-600 uppercase tracking-wide mb-1">
                                                Name
                                            </span>
                                            <div
                                                class="w-full bg-white rounded-md px-3 py-2.5 border border-gray-200 shadow-sm hover:shadow transition">
                                                <span
                                                    class="text-sm text-gray-900 font-medium break-words">
                                                    {{
                                                        applicationTypeData.name
                                ...
                                <div class="px-6 py-4">
                                    <div
                                        ...
                                        <button
                                            v-for="(
                                                file, index
                                            ) in applicationData.fileUploads"
                                            :key="index"
                                            @click="openImageModal(file)"
                                            ...
                                            <div
                                                class="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/50 to-transparent text-white text-xs text-center py-1">
                                                <span
                                                    class="inline-block truncate px-2"
                                                    >File {{ index + 1 }}</span
                                                >
                                            </div>
                                        </button>
                            ...
                            <div
                                ...
                                <div class="px-5 py-4">
                                    <div
                                        ...
                                        <div class="flex flex-col">
                                            <span
                                                class="text-[10px] font-semibold text-green-700 uppercase tracking-wide mb-1">
                                                Application ID
                                            </span>
                                            <div
                                                class="w-full bg-white rounded-md px-3 py-2.5 border border-gray-200 shadow-sm hover:shadow transition">
                        ...
                        <div
                            ...
                            <div
                                ...
                                :class="verificationCardClasses">
                                <!-- Verification header removed (display only content) -->

                                <div class="px-3 py-3">
                                    <!-- Verification Complete -->
                                    <div
                                        v-if="insuranceData?.verification"
                                        class="space-y-6">
                                        <!-- Simple Verification Completed (small green vibe) -->
                                        <div
                                            class="flex items-center gap-3 p-2 rounded-xl">
                                            <div
                                                class="flex-shrink-0 bg-green-600 rounded-full p-1.5">
                                                <CheckCircleIcon
                                        ...
                                        <div
                                            v-if="
                                                insuranceData.verification
                                                    .fieldValues
                                            "
                                            class="bg-yellow-100 p-4 rounded-lg border border-yellow-300">
                                            <h5
                                                class="text-sm font-semibold text-yellow-800 mb-1">
                                                Verified Field Information
                                            </h5>
                                            <p class="text-sm text-yellow-700">
                                                Field values were validated as
                                    ...
                                    <div
                                        ...
                                        <div class="text-center">
                                            <!-- Icon -->
                                            <div
                                                class="mx-auto h-14 w-14 flex items-center justify-center rounded-xl bg-red-100 border border-red-100">
                                                <ExclamationTriangleIcon
                                            ...
                                            <p
                                                class="mt-1 text-sm text-gray-800 max-w-sm mx-auto">
                                                This application is still
                                                waiting for an authorized
                                                verifier to review and approve
                                                it.
                                            </p>
                                            ...
                                            <router-link
                                                ...
                                                class="mt-5 inline-flex items-center px-5 py-2.5 rounded-lg shadow bg-green-600 text-white font-medium hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-600 transition-all">
                                                Start Verification
                                            </router-link>
                                        </div>
                                    </div>
                            ...
                            <div
                                ...
                                <div class="px-6 py-4">
                                    <div
                                        ...
                                        <div
                                            v-if="
                                                insuranceData.inspection.photos
                                                    ?.length > 0
                                            "
                                            class="mt-6">
                                            <h4
                                    ...
                                    <div
                                        ...
                                        <div class="text-center">
                                            ...
                                            <p
                                                ...
                                                Field inspection has not been
                                                scheduled for this application
                                                yet. An inspector will be
                                                assigned soon.
                                            </p>
                                        </div>
                                    </div>
                            ...
                            <div
                                ...
                                <div class="px-6 py-4">
                                    <!-- Policy Complete -->
                                    <div
                                        v-if="insuranceData?.policy"
                                        class="space-y-6">
                                        <!-- Success Header with Icon -->
                                        <div
                                            class="flex items-center space-x-3 p-4 bg-purple-50 rounded-lg border border-purple-200">
                                            <div class="flex-shrink-0">
                                                <CheckCircleIcon
                                        ...
                                        <div
                                            v-if="
                                                insuranceData.policy.terms ||
                                                insuranceData.policy.conditions
                                            "
                                            ...
                                            <p class="text-sm text-gray-600">
                                                Policy terms and conditions are
                                                active. Please refer to your
                                                policy document for complete
                                                details.
                                            </p>
                                        </div>
                                    </div>
                            ...
                            <!-- Claim Information -->
                            <div
                                v-if="shouldShowClaim"
                                class="bg-gray-100 shadow-sm border border-gray-300 rounded-xl overflow-hidden">
                                <div class="px-6 py-4">
                                    <!-- Claim Complete -->
                                    <div
                                        v-if="insuranceData?.claim"
                                        class="space-y-6">
                                        <!-- Success Header with Icon -->
                                        <div
                                            class="flex items-center space-x-3 p-4 bg-orange-50 rounded-lg border border-orange-200">
                                            <div class="flex-shrink-0">
                                                <CheckCircleIcon
                                            ...
                                            <div class="flex-1">
                                                <h4
                                                    class="text-lg font-medium text-orange-800">
                                        ...
                                        <div
                                            v-if="insuranceData.claim.remarks"
                                            class="bg-gray-50 p-4 rounded-lg">
                                            <h5
                                                class="text-sm font-medium text-gray-900 mb-2">
                                                Claim Remarks
                                    ...
                                    <div
                                        ...
                                        <div class="text-center">
                                            ...
                                            <p
                                                ...
                                                filed for this application yet.
                                                Claims can be filed when crop
                                                damage occurs.
                                            </p>
                                        </div>
                                    </div>
                        ...
                        <div
                            v-if="!applicationData && !loading && !error"
                            class="flex justify-center items-center flex-1 min-h-96">
                            <div class="text-center">
                                <div
...
async function fetchApplicationDetails() {
    console.log(
        'fetchApplicationDetails called with route.params.id:',
        route.params.id,
        'applicationTypeId:',
    ...
    try {
        ...
        console.log(
            'ApplicationDetail: Starting parallel fetch for application ID:',
            route.params.id,
            'and application type ID:',
            route.params.applicationTypeId,
        )

        // Fetch all data in parallel for faster loading
        const [applicationResult, applicationTypeResult, insuranceResult] =
            await Promise.allSettled([
                applicationStore.fetchApplicationById(route.params.id),
                applicationTypeStore.fetchApplicationTypesById(
                    route.params.applicationTypeId,
                    false,
                ),
        ...
        if (
            ...
            applicationResult.value.success
        ) {
        ...
        if (
            applicationTypeResult.status === 'fulfilled' &&
            applicationTypeResult.value.success
        ) {
            applicationTypeData.value = applicationTypeResult.value.data
            console.log(
                'Application type data fetched:',
                applicationTypeData.value,
            )
        } else {
            const errorMsg =
                applicationTypeResult.status === 'rejected'
        ...
        if (
            ...
            const errorMsg =
                insuranceResult.status === 'rejected'
    ...
    nextTick(() => {
        try {
            if (metadataRef.value && metadataRef.value.scrollIntoView) {
                metadataRef.value.scrollIntoView({
            ...
            if (leftColumnRef.value)
                leftColumnRef.value.scrollTop = leftColumnRef.value.scrollHeight
        }
    })
}
...
const getApplicationTitle = () => {
    if (applicationTypeData.value && applicationData.value?.dynamicFields) {
        ...
        const identifier =
            fields.cic_no || fields.id || fields.application_number
    ...
    Object.entries(dynamicFields).forEach(([key, value]) => {
        ...
        if (typeof value === 'object') {
            if (key.includes('location')) {
                ...
                const hasLocationData = Object.values(value).some(
                    locationValue =>
                        locationValue &&
                ...
                const hasBoundaryData = Object.values(value).some(
                    boundaryValue =>
                        boundaryValue &&
        ...
        if (key.includes('date') && value && typeof value === 'string') {
            ...
            if (boundaries.north && boundaries.north.trim())
                boundaryParts.push(`North: ${boundaries.north}`)
            if (boundaries.south && boundaries.south.trim())
                boundaryParts.push(`South: ${boundaries.south}`)
            if (boundaries.east && boundaries.east.trim())
                boundaryParts.push(`East: ${boundaries.east}`)
            if (boundaries.west && boundaries.west.trim())
                boundaryParts.push(`West: ${boundaries.west}`)
...
const verificationCardClasses = computed(() => {
    ...
    return [
        ...
        verified
            ? 'border border-green-500 bg-green-100 text-white'
            : 'border border-gray-300 bg-red-200 text-green-600',
    ].join(' ')
})
...
const verificationHeaderClasses = computed(() => {
    ...
    return [
        ...
        verified
            ? 'border-b border-green-200 bg-green-200 text-gray-800'
            : 'border-b border-gray-300 bg-white text-gray-800',
    ].join(' ')
})
...
watch(
    ...
    (newId, oldId) => {
        console.log(
            'ApplicationDetail: Route param changed from',
            oldId,
            'to',
            newId,
        )
...
watch(
    ...
    (newPath, oldPath) => {
        console.log(
            'ApplicationDetail: Route path changed from',
            oldPath,
            'to',
            newPath,
        )
