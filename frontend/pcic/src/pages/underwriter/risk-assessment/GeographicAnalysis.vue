  ...
  >
    ...
    <template #header>
      <div class="flex items-center justify-between">
        <div>
          <h2 class="text-2xl font-bold text-green-600">Geographic Analysis</h2>
        ...
        <div class="flex items-center space-x-3">
          ...
          <button
            ...
            :disabled="loading"
            class="inline-flex mr-2 items-center px-4 py-2 border border-gray-300 rounded-md text-sm font-medium text-white bg-green-600 hover:bg-green-700 disabled:opacity-50"
          >
