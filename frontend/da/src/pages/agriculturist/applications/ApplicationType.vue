  ...
  <AuthenticatedLayout>
    <div class="p-4 sm:p-6 min-h-screen flex flex-col space-y-6">
      ...
      <div class="flex flex-col sm:flex-row sm:justify-between 
                  items-start sm:items-center border-b border-gray-200 pb-3">
        ...
        >
          <div class="flex items-center justify-between">
            <div class="flex items-center min-w-0">
              <div
                class="p-3 rounded-lg bg-green-100 flex-shrink-0 
                       group-hover:bg-green-200 transition-colors"
              >
                <component
                  :is="getApplicationTypeIcon(applicationType)"
              ...
              <div class="flex items-center space-x-2">
                <span
                  class="inline-flex items-center px-2.5 py-0.5 rounded-full 
                         text-xs font-medium bg-green-600 text-white"
                >
