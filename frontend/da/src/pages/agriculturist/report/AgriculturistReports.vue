...
<template>
  <AuthenticatedLayout
    ...
    page-title="Reports">
    <FeatureUnavailable
      title="Municipal Agriculturist Reports"
      description="This survey management feature is currently under development. We're working hard to bring you a comprehensive tool for generating agricultural reports."
      @back="handleBack"
    />
  </AuthenticatedLayout>
</template>
